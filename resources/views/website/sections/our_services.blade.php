            ...
            <div class="col-xs-12 col-sm-12">
                <div class="testimonials owl-carousel">
                    ...
                    <div class="testimonial">
                        <div class="img">
                            <img src="{{asset('website/img/testimonials/testimonial-1.jpg')}}" alt="Alex Smith">
                        </div>
                        <div class="text">
                    ...
                    <div class="testimonial">
                        <div class="img">
                            <img src="{{asset('website/img/testimonials/testimonial-2.jpg')}}" alt="Alex Smith">
                        </div>
                        <div class="text">
                            <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor. Nulla condimentum nunc sit amet urna tempus finibus. Duis mollis leo id ligula pellentesque, at vehicula dui ultrices.</p>
                        </div>
                    ...
                    <div class="testimonial">
                        <div class="img">
                            <img src="{{asset('website/img/testimonials/testimonial-3.jpg')}}" alt="Alex Smith">
                        </div>
                        <div class="text">
                            <p>Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor. Nulla condimentum nunc sit amet urna tempus finibus. Duis mollis leo id ligula pellentesque, at vehicula dui ultrices.</p>
                        </div>
